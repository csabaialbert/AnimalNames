...
@section('content')
    <form method="POST" action="/database/year/list" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-6">
            <label for="year" class="sr-only inline-block text-lg font-bold mb-2">Novel publishing years</label>
            <select name="year"
                ...
                required>
                <option value="" disabled selected>Select publishing year...</option>
